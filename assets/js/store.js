...
fetch("http://localhost:3000/product")
  ...
  .then((data) => {
    ...
    arrProduct.slice(start, end).map((card) => {
      console.log(arrProduct.slice(start, end));
    ...
    //     page = e.target.parentNode.getAttribute("pagination-id");
    //     start = (page - 1) * perpage;
    //     end = page * perpage;
    //     arrProduct.slice(start, end).reverse().map((card) => {
    //       product.insertAdjacentHTML(
    //         "afterbegin",
    //         `
    //                 <div class="col-xl-3 col-md-6 mt-3" data-id=${card.id}>
    //                     <div class="card">
    //                         <img class="card-img-top align-self-center" src=${card.image} alt="Card image cap" style="width: 160px; height: 160px;">
    //                         <div class="card-body">
    //                             <h5 class="card-title border-bottom fw-bold">${card.title}</h5>
